...
### Unfortunately, none of our chi-squares tests were signficant. This may be due to the way the age groups were coded, or an error in the test I used.

# Step 8: To explore if the lack of significance was due to the coding of age groups, or if the relationship only exists among those 12-21 years old, let's filter the data to that age range and re-run our tests. 
